                ...
                <div className="overflow-x-auto mt-4">
                    <table className="w-full border border-gray-700 rounded-lg overflow-hidden text-gray-200">
                        ...
                        <tr>
                            ...
                            <th className="px-4 py-2 border border-gray-700">last OIL</th>
                            <th className="px-4 py-2 border border-gray-700">last AIR</th>
                        ...
                        {vehicles.map((vehicle) => (
                            <tr key={vehicle._id} className="bg-gray-900 hover:bg-gray-800">
                                ...
                                <td className="px-4 py-2 border border-gray-700">{vehicle.last_oil_date}</td>
                                <td className="px-4 py-2 border border-gray-700">{vehicle.last_air_date}</td>
                                <td className="px-4 py-2 border border-gray-700 space-x-2">
                                    <button onClick={() => updateVehicle(vehicle)} className="bg-blue-600 hover:bg-blue-500 px-3 py-1 rounded text-white">View maintenance</button>
