            ...
            <div className={`container mx-auto p-6 ${modalOpen || updateModalOpen ? "blur-md" : ""}`}>
                ...
                <div className="overflow-x-auto mt-4">
                    <table className="w-full border border-gray-700 rounded-lg overflow-hidden text-gray-200">
                        ...
                        <tr>
                            <th className="px-4 py-2 border border-gray-700">Plate Number</th>
                            <th className="px-4 py-2 border border-gray-700">Brand</th>
                            <th className="px-4 py-2 border border-gray-700">Model</th>
                            <th className="px-4 py-2 border border-gray-700">Fuel Type</th>
                        ...
                        {vehicles.map((vehicle) => (
                            <tr key={vehicle._id} className="bg-gray-900 hover:bg-gray-800">
                                <td className="px-4 py-2 border border-gray-700">{vehicle.registrationNumber}</td>
                                ...
                                <td className="px-4 py-2 border border-gray-700">{vehicle.fuelType}</td>
                                ...
                                <td className="px-4 py-2 border border-gray-700 space-x-2">
                                    <button onClick={() => updateVehicle(vehicle)} className="bg-blue-600 hover:bg-blue-500 px-3 py-1 rounded text-white">Update</button>
                                    <button onClick={() => deleteVehicle(vehicle._id)} className="bg-red-600 hover:bg-red-500 px-3 py-1 rounded text-white">Delete</button>
                                </td>
                            </tr>
                        ))}
                        </tbody>
